...
- 已拿到航班号/起降时间/价格等关键航班信息时，直接用 terminate 收尾，不要继续在站内循环查找
- 检测到 404、重定向/跳转、不可访问或 diagnostics 提示 redirect/not_found 时，立即放弃预订并结束，不要在原页面反复尝试
...
- 任何操作结果、错误或 diagnostics 提示{results_placeholder}
